onRecordBeforeAuthWithOAuth2Request((e) => {
	...
	if (requestProvider !== userRecordProvider) {
		throw new ForbiddenError(`Account already authenticated with ${userRecordProvider}`);
	}
...
onRecordAfterAuthWithOAuth2Request((e) => {
	...
	const username = e.oAuth2User.username !== '' ? e.oAuth2User.username : e.oAuth2User.name;
